...
namespace Inventory.Tests.Data
{
    ...
    public class InventoryItemTests
    {
        ...
        public void CreateInventoryItem()
        {
            ...
            const int c_Price = 1;
            const int c_Stock = 1;
            SupplierItem item = new SupplierItem(c_ItemName, c_CategoryName, c_Price, c_Stock);
        ...
        {
            Assert.Throws(typeof(ArgumentException), delegate { new SupplierItem(itemName, "category", 1, 1); });
        }
        ...
        {
            Assert.Throws(typeof(ArgumentException), delegate { new SupplierItem("Item1", category, 1,1); });
        }
